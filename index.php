...
if (isset($_SESSION['id']) && !empty($_SESSION['id'])) {
  ...
  $db_host = 'mysql-container'; // MySQL container hostname
  $db_user = 'root'; // MySQL username
  $db_pass = 'your_password'; // MySQL password
  $db_name = 'krankencare'; // MySQL database name
				...
				<div class="col-lg-8 col-md-8 col-sm-8">
					<form id="login-form" class="contact__form" method="post" action="">
						<div class="form-group">
							...
							<input name="email" id="email" type="email" class="form-control <?= empty($errors['email']) ?: 'invalid-input' ?>" placeholder="Enter your email address" value="<?= isset($email) && $has_errors ? $email : '' ?>">
					...
					<div class="row">
						<div class="col-12 text-center mt-4">
							<p Style="color: #005073">New to Krankencare? <a href="check.php">Create Account</a></p>
						</div>
					</div>
				</div>
			</div>
